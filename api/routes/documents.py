...
def delete_document(
    ...
    if db_document.file_name and fs.exists(db_document.file_name):
        try:
            fs.delete_file(db_document.file_name)
