...
class ExtractionResult(BaseModel):
    ...
    input_tokens: Optional[int] = Field(None, description="Number of input tokens used by LLM")
    output_tokens: Optional[int] = Field(None, description="Number of output tokens generated by LLM")
